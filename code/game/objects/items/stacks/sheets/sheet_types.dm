...
/*		new/datum/stack_recipe("science airlock assembly", /obj/structure/door_assembly/door_assembly_science, 4, time = 50, one_per_turf = 1, on_floor = 1), \ */
		...
		new/datum/stack_recipe("multi-tile glass airlock assembly", /obj/structure/door_assembly/multi_tile, 4, time = 50, one_per_turf = 1, on_floor = 1), \
		new/datum/stack_recipe("multi-tile metal airlock assembly", /obj/structure/door_assembly/multi_tile/metal, 4, time = 50, one_per_turf = 1, on_floor = 1), \
		), 4), \
	null, \
...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	...
	new/datum/stack_recipe("rifle stock", /obj/item/weaponcrafting/stock, 3, time = 10), \
