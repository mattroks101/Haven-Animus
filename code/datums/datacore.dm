...
proc/get_id_photo(var/mob/living/carbon/human/H)
	...
	preview_icon.Blend(temp, ICON_OVERLAY)
	temp = new /icon(icobase, "l_arm_[g]")
	preview_icon.Blend(temp, ICON_OVERLAY)
	temp = new /icon(icobase, "r_arm_[g]")
	preview_icon.Blend(temp, ICON_OVERLAY)
	temp = new /icon(icobase, "l_leg_[g]")
	preview_icon.Blend(temp, ICON_OVERLAY)
	temp = new /icon(icobase, "r_leg_[g]")
	preview_icon.Blend(temp, ICON_OVERLAY)
	temp = new /icon(icobase, "l_foot_[g]")
	preview_icon.Blend(temp, ICON_OVERLAY)
	temp = new /icon(icobase, "r_foot_[g]")
	preview_icon.Blend(temp, ICON_OVERLAY)
	temp = new /icon(icobase, "l_hand_[g]")
	preview_icon.Blend(temp, ICON_OVERLAY)
	temp = new /icon(icobase, "r_hand_[g]")
	preview_icon.Blend(temp, ICON_OVERLAY)
	...
	if(J)
		...
		clothes = new /icon('icons/mob/uniform.dmi', initial(UF.icon_state))
