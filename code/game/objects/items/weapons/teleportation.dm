...
/obj/item/weapon/locator/Topic(href, href_list)
	...
	if(!current_location||current_location.z==6)//If turf was not found or they're on z level 2.
...
/obj/item/weapon/hand_tele/attack_self(mob/user as mob)
	...
	if(!current_location || current_location.z>=9)//If turf was not found or they're on z level 2 or >7 which does not currently exist.
