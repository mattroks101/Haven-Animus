	...
	for(var/mob/living/silicon/ai/M in living_mob_list)
		if(M.stat != 2 && M.see_in_dark != 0)
			...
			switch(rand(1,14))
				if(1)
					M << "<br>"
					M << "\red THERE ARE [amount] [who2] ON THE VESSEL...LAWS UPDATED"
					M << "<br>"
					M.add_ion_law("THERE ARE [amount] [who2] ON THE VESSEL")
				if(2)
					M << "<br>"
				...
				if(3)
					M << "<br>"
					M << "\red THE ESCAPE-SHUTTLE CANNOT BE CALLED BECAUSE OF [who2] ON THE VESSEL...LAWS UPDATED"
					M << "<br>"
					M.add_ion_law("THE ESCAPE SHUTTLE CANNOT BE CALLED BECAUSE OF [who2] ON THE VESSEL")
				if(4)
					M << "<br>"
				...
				if(6)
					M << "<br>"
					M << "\red THE VESSEL IS BUILT FOR [who2]...LAWS UPDATED"
					M << "<br>"
					M.add_ion_law("THE VESSEL IS BUILT FOR [who2]")
				if(7)
					M << "<br>"
				...
				if(14)
					M << "<br>"
					M << "\red THE VESSEL IS [who2pref] [who2]...LAWS UPDATED"
					M << "<br>"
					M.add_ion_law("THE VESSEL IS [who2pref] [who2]")
