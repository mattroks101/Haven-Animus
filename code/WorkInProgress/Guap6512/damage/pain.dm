...
mob/living/carbon/human/proc/handle_pain()
	...
	for(var/organ_name in internal_organs)
		var/datum/organ/internal/I = internal_organs_by_name[organ_name]
	...
	switch(getToxLoss())
		if(1 to 5)
			toxMessageProb = 1
			toxDamageMessage = "Your abdomen stings slightly."
		if(6 to 10)
			toxMessageProb = 2
			toxDamageMessage = "Your abdomen hurts a little."
		if(11 to 15)
			toxMessageProb = 2
			toxDamageMessage = "Your abdomen hurts."
		if(15 to 25)
			toxMessageProb = 3
			toxDamageMessage = "Your abdomen hurts badly."
		if(26 to INFINITY)
			toxMessageProb = 5
			toxDamageMessage = "Your abdomen aches, it's driving you mad."
