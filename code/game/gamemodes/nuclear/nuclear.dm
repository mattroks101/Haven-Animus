...
/datum/game_mode/proc/equip_syndicate(mob/living/carbon/human/synd_mob)
	...
	synd_mob.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(synd_mob), slot_shoes)
...
/*/proc/nukelastname(var/mob/M as mob) //--All praise goes to NEO|Phyte, all blame goes to DH, and it was Cindi-Kate's idea. Also praise Urist for copypasta ho.
	...
	var/newname = sanitize(input(M,"You are the nuke operative [pick("Czar", "Boss", "Commander", "Chief", "Kingpin", "Director", "Overlord")]. Please choose a last name for your family.", "Name change",randomname))
